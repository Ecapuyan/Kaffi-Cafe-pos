...
import 'package:kaffi_cafe_pos/screens/feedback_screen.dart';
...
class _SalesReportScreenState extends State<SalesReportScreen>
      ...
      case 'Daily':
        for (int i = 6; i >= 0; i--) {
          ...
          final snapshot = await _firestore
              ...
              .where('timestamp',
                  isLessThanOrEqualTo: Timestamp.fromDate(nextDate))
              .get();
  ...
  Future<void> _printSalesReport() async {
    ...
    try {
      ...
      final bestSellers = await _getBestSellersData(
          _selectedPeriod == 'Custom' ? 'Daily' : _selectedPeriod);
          ...
          build: (pw.Context context) {
            return [
              ...
              pw.Table.fromTextArray(
                ...
                headers: const ['Item Name', 'Quantity Sold', 'Total Revenue'],
                data: bestSellers
                    .map((item) => [
                          item['name'],
